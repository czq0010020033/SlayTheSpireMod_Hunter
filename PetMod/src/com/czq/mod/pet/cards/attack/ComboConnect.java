 ...
 * 版本：1.0
 */
public class ComboConnect extends AbstractComboAttackCard {
	private static final Logger logger = LogManager
			.getLogger(ComboConnect.class.getName());
	public static final String ID = "Combo Connect";
