...
public class FinalFist extends AbstractCard {
	private static final Logger logger = LogManager.getLogger(FinalFist.class
			.getName());
	public static final String ID = "FinalFist";
	...
	public AbstractCard makeCopy() {
		return new FinalFist();
	}

	public void calculateCardDamage(AbstractMonster mo) {
		for (AbstractPower p : mo.powers) {
			if (p.ID.equals(FistPower.POWER_ID) && p.amount == 2) {
