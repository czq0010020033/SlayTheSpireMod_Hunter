...
public class HealerPetCall
  extends PetCall
{
  public static final String ID = "HealerPetCall";
 // private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Defend_R");
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("HealerPetCall");
  public static final String NAME = cardStrings.NAME;
  public static final String DESCRIPTION = cardStrings.DESCRIPTION;
  public static final String UPGRADE_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;
  public HealerPetCall()
  {
  ...
  {
     return makePetCopy(new HealerPetCall());
  }
  public void upgrade() {
		if (!this.upgraded) {
			upgradeName();
