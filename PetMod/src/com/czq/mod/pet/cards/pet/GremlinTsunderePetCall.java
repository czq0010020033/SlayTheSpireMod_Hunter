...
public class GremlinTsunderePetCall
  extends PetCall
{
  public static final String ID = "GremlinTsunderePetCall";
 // private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Defend_R");
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("GremlinTsunderePetCall");
  public static final String NAME = cardStrings.NAME;
  public static final String DESCRIPTION = cardStrings.DESCRIPTION;
  public static final String UPGRADE_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;

  public GremlinTsunderePetCall()
  {
 ...
 /* public void use(AbstractPlayer p, AbstractMonster m) {
  ...
  {
    return makePetCopy(new GremlinTsunderePetCall());
  }
	  public void upgrade() {
			if (!this.upgraded) {
				upgradeName();
