...
public class BeastMaster extends AbstractModCard {
	...
	public BeastMaster() {
		super(ID, NAME, "red/power/demon_form", COST, DESCRIPTION,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
				new BeastMasterPower(p, this.magicNumber), this.magicNumber));
	}
