 ...
 * 版本：1.0
 */
public abstract class AbstractComboDefendCard extends AbstractComboCard {
	public AbstractComboDefendCard(String id, String name, String jokeUrl, String imgUrl,
	...
	public AbstractComboDefendCard(String id, String name, String imgUrl,
			int cost, String rawDescription, CardType type, CardColor color,
			CardRarity rarity, CardTarget target, int level) {
