...
public class DiscoverCombo
  extends AbstractModCard
{
  public static final String ID = "Discover Combo";
  ...
  {
    AbstractDungeon.actionManager.addToBottom(new DiscoveryAction(CardTypeEnum.COMBO));
  }
  
  public AbstractCard makeCopy()
  {
    return new DiscoverCombo();
  }
