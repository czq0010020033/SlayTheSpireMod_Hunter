...
public class DeathExplode extends AbstractModCustomCard {
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, m,
				new DeathRattleExplodePower(m, m.maxHealth * this.magicNumber),
				m.maxHealth * this.magicNumber));
