  ...
  extends Pet
{
  ...
  public HealerPet(int mana, float x){
	  this(mana, x, 0);
  }
  
  public HealerPet(int mana, float x, float y)
  {
  ...
  public void takeTurn()
  {
    ...
    case 1: 
      ...
      AbstractDungeon.actionManager.addToBottom(new DamageAction(monster, 
        ...
        (DamageInfo)this.damage.get(0), AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
      
      AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(monster, this, new FrailPower(monster, 2, true), 2));
    	}
      break;
    case 2: 
      playSfx();
      ...
      for (AbstractMonster m : GiantModHelper.pets) {
        if ((!m.isDying) && (!m.isEscaping)) {
          AbstractDungeon.actionManager.addToBottom(new HealAction(m, this, heal));
        }
      }
      AbstractDungeon.actionManager.addToBottom(new HealAction(AbstractDungeon.player, this, heal));
      break;
    case 3: 
      playSfx();
      AbstractDungeon.actionManager.addToBottom(new ChangeStateAction(this, "STAFF_RAISE"));
      ...
      AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new StrengthPower(AbstractDungeon.player, this.strAmt), this.strAmt));
      break;
    }
  ...
  public void die()
  {
	...
	public void applySpirit(int amount){
		if(this.heal == 6 + amount * 3){
			return;
		}
		this.heal = 6 + amount*3;
