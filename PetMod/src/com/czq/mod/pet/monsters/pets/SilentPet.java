...
public class SilentPet extends Pet {
	private static final Logger logger = LogManager.getLogger(SilentPet.class
			.getName());
	...
	public SilentPet(int mana, float x) {
		this(mana, x, 0, true);
	}

	public SilentPet(int mana, float x, float y, boolean talk) {
