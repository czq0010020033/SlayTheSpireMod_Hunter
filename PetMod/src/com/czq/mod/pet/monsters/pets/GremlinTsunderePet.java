...
public class GremlinTsunderePet
  extends Pet
{
  ...
  public GremlinTsunderePet(int mana,float x){
	  this(mana, x, 0);
  }
  
  public GremlinTsunderePet(int mana, float x, float y)
  {
    super(NAME, "GremlinTsunderePet", 10, 0.0F, 0.0F, 120.0F, 200.0F, null, x, y);
  ...
  public void takeTurn()
  {
    ...
    {
    case 1: 
      AbstractDungeon.actionManager.addToBottom(new GainBlockAction( AbstractDungeon.player,this, this.blockAmt));
    ...
    case 3:
    	...
    	if(monster != null)
    	{
          ...
          AbstractDungeon.actionManager.addToBottom(new DamageAction(monster, 
            ...
            (DamageInfo)this.damage.get(0), AbstractGameAction.AttackEffect.BLUNT_LIGHT));
    	}
    	break;
    case 99: 
  ...
  public void applySpirit(int amount){
		if(this.blockAmt == 8 + amount * 4)
			return;
		this.blockAmt = 8 + amount * 4;
		getMove(1);
		createIntent();
	}
