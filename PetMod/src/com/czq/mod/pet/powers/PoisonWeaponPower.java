...
public class PoisonWeaponPower extends AbstractPower {
	public static final String POWER_ID = "Poison Weapon";
	private static final PowerStrings powerStrings = CardCrawlGame.languagePack
			.getPowerStrings(POWER_ID);
	public static final String NAME = powerStrings.NAME;
	public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

	public PoisonWeaponPower(AbstractCreature owner, int drawAmt) {
		this.name = NAME;
		this.ID = POWER_ID;
		this.owner = owner;
		this.amount = drawAmt;
